...
def day_two(day_two_deliveries):
    for line in day_two_deliveries:
        line = line.rstrip()
        words = line.split('|')
...
day_two(day_two_deliveries)

def day_three(day_three_deliveries):
    for line in day_three_deliveries:
        line = line.rstrip()
        words = line.split('|')
...
day_three(day_three_deliveries)
